...
ngx_http_core_run_phases(ngx_http_request_t *r)
{
	...
	ngx_log_error(1, r->connection->log, 0,
					   "panpan test, in ngx_http_core_run_phases, go in.\n");
    ...
    while (ph[r->phase_handler].checker) {
		ngx_log_error(1, r->connection->log, 0,
							   "panpan test, in ngx_http_core_run_phases, r->phase_handler = %d.\n", 
							   r->phase_handler);
...
ngx_http_core_generic_phase(ngx_http_request_t *r, ngx_http_phase_handler_t *ph)
{
    ...
    ngx_log_error(1, r->connection->log, 0,
                   "panpan test, in ngx_http_core_generic_phase, generic phase: %ui", r->phase_handler);
    ...
    ngx_str_t *ct, ngx_http_complex_value_t *cv)
{
	...
	ngx_log_error(1, r->connection->log, 0, 
			"panpan test, in ngx_http_send_response, go to ngx_http_output_filter.\n");
...
ngx_http_send_header(ngx_http_request_t *r)
{
	...
	ngx_log_error(1, r->connection->log, 0,
						  "panpan test, in ngx_http_send_header, go in.\n");
...
ngx_http_output_filter(ngx_http_request_t *r, ngx_chain_t *in)
{
    ...
    ngx_log_error(1, c->log, 0,
                   "panpan test, in ngx_http_output_filter, http output filter \"%V?%V\"", &r->uri, &r->args);
